...
export function ValidateAssumptionsPage() {
  ...
  const problem = businessPlan?.problem?.description || 'their main problem';
  ...
  const validationSteps = [
    {
      ...
      description: `Interview 5-10 ${customer} to understand their pain points and validate your problem statement. Example question: "What's your biggest challenge with ${problem}?"`
    },
    {
      key: 'landing_page',
      title: 'Create a Landing Page',
      description: `Build a simple landing page to gauge interest in ${solution} and collect email addresses. Headline suggestion: "Struggling with ${problem}? Discover how ${solution} can help."`
    },
    {
      key: 'email_collection',
      title: 'Collect Emails',
      description: 'Collect at least 20 emails from interested customers to validate demand.'
    }
  ];
  ...
  return (
    <PageContainer>
      ...
      <StepCard>
        <StepTitle>Validation Steps</StepTitle>
        <StepDescription>
          Before building your MVP, validate that your target customers actually have the problem you're solving and are interested in your solution.
        </StepDescription>
        <ProgressSection>
