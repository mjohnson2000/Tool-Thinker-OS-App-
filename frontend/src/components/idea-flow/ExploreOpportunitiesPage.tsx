...
export function ExploreOpportunitiesPage() {
  ...
  useEffect(() => {
    async function fetchPlan() {
      ...
      try {
        ...
        const userProgress = res.data?.mvp?.userProgress?.explore;
        if (userProgress) {
  ...
  const exploreSteps = [
    {
      ...
      description: `Review feedback from your MVP users. What did ${customer} like or dislike? What features did they request?`
    },
    {
      key: 'identify_opportunities',
      title: 'Identify New Opportunities',
      description: `Based on feedback, identify new features, markets, or pivots for ${mvpSummary}.`
    },
    {
      key: 'prioritize_next_steps',
      title: 'Prioritize Next Steps',
      description: 'Decide which opportunities to pursue next. Consider impact, effort, and alignment with your vision.'
    }
  ];
  ...
  return (
    <PageContainer>
      ...
      <StepCard>
        <StepTitle>Opportunity Exploration</StepTitle>
        <StepDescription>
          Use feedback and results from your MVP to discover new growth areas, features, or pivots. This is a collaborative, iterative process—let your users guide your next move!
        </StepDescription>
        <ProgressSection>
        ...
        <FeedbackSection>
          ...
          <TextArea
            placeholder="Share what you've learned, new ideas, or pivots you're considering..."
            value={feedback}
